...
class MarkdownParser(BaseDocumentParser):
    ...
    def can_parse(self, content: str, filename: Optional[str] = None) -> bool:
        ...
        has_formatting = bool(
            self.bold_pattern.search(content) or self.italic_pattern.search(content)
        )
    ...
    def _detect_code_language(self, code_content: str) -> str:
        ...
        if 'def ' in code_content or 'import ' in code_content or 'print(' in code_content:
            return 'python'
        elif ('function ' in code_content or 'const ' in code_content or
              'console.log' in code_content):
            return 'javascript'
