...
def mock_audio_environment(monkeypatch):
    ...
    monkeypatch.setattr("matilda_voice.internal.audio_utils.check_audio_environment", env_mock.check_audio_environment)
...
def mock_audio_file_operations(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("matilda_voice.internal.audio_utils.stream_audio_file", mock_stream_audio_file)
...
def create_audio_conversion_failure_scenario(monkeypatch) -> None:
    ...
    monkeypatch.setattr("matilda_voice.internal.audio_utils.convert_audio", failing_convert_audio)
